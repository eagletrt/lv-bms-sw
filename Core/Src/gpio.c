...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SUPPLY_EN_Pin|SUPPLY_DELAY_FB_Pin|SUPPLY_DELAY_SET_Pin|LED1_Pin
  ...
  /*Configure GPIO pins : SUPPLY_EN_Pin SUPPLY_DELAY_FB_Pin SUPPLY_DELAY_SET_Pin LED1_Pin
                           LED2_Pin */
  GPIO_InitStruct.Pin = SUPPLY_EN_Pin|SUPPLY_DELAY_FB_Pin|SUPPLY_DELAY_SET_Pin|LED1_Pin
                          |LED2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
